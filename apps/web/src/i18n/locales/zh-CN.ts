...
export const zhCN: Dict = {
  ...
  'chat.inspect.noEditableTargets': '当前页面还没有可编辑的元素。',
  'chat.inspect.noCommentTargets': '当前页面还没有可注释的元素。',
  'chat.inspect.editHint': '点击画面中的元素编辑样式。',
  'chat.inspect.commentHint': '点击画面中的元素添加注释。',
