...
export const zhTW: Dict = {
  ...
  'chat.inspect.noEditableTargets': '目前頁面還沒有可編輯的元素。',
  'chat.inspect.noCommentTargets': '目前頁面還沒有可註解的元素。',
  'chat.inspect.editHint': '點擊畫面中的元素以編輯樣式。',
  'chat.inspect.commentHint': '點擊畫面中的元素以新增註解。',
